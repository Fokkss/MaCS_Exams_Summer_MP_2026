...
Доказательство2. $\triangleright$

1. Для преобразования столбцов очевидно, что линейная комбинация векторов дант ту же оболочку $\Rightarrow$ тот же ранг.

2. Преобразования строк.

$$B = UA$$

Пусть $A[, i_{j}]$ - ЛНС размера r

Пусть не так. $B[, i_{j}]$ - не ЛНС.

$
\Rightarrow \ \exists [d]_e  = 
\begin{pmatrix}
0\\
\dots\\
\lambda _i\\
...
$$
Bd = 0, \ UAd = 0 \Rightarrow Ad = 0
$$ Противоречие.

$$
\mathrm rk A \le \mathrm rk B
$$

Далее аналогично $B = U^{-1} A$
...
Зам.: $\diamond$ доказать по инудкции.
...
Мономорфизм - инънктивный гомоморфизм

Эпиморфизм - сюръективный гомоморфизм

Изоморфизм - бинективный гомоморфизм
...
Предложение. $Let R$ - ОГИ, $b \in R$, Тогда $R/(b)$ - поле $\Leftrightarrow b$ неприводимый
...
Теорема. $Let \ \mathrm{Aut}(\mathbb{F}_{p^n}) \cong C^n = \langle \mathrm{Fr} :x \rightarrow x^p\rangle$

Доказательство. $\triangleright$
$\Phi \leftrightharpoons \mathrm{Fr}$
$ord \Phi = n$:
